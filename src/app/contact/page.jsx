                ...
                <div className="md:flex justify-between px-8 mt-20 gap-40 ">
                    ...
                    <div>
                        <form>
                            ...
                            <div className="form-control mt-5">
                                <input type="text" placeholder="Email" name='email' className="input bg-white input-bordered border-2  focus:outline-none rounded-xl" required />
                            </div>
                            <div className="form-control mt-5">
                                <input type="text" placeholder="Phone" name='phone' className="input bg-white input-bordered border-2  focus:outline-none rounded-xl" required />
                            </div>
                            <div>
